defmodule CascadeWeb.OrchestrationRouter do
  ...
  get "/api/execution-admission-v1", do: OrchestrationController.execution_admission(conn)
  get "/api/work-items/:id/repository-binding-v1", do: OrchestrationController.repository_binding(conn, id)
  put "/api/work-items/:id/repository-binding-v1", do: OrchestrationController.bind_repository(conn, id)
