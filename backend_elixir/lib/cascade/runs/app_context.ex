defmodule Cascade.Runs.AppContext do
  ...
  @seed "Fizzer is a user-facing, Obsidian-style workspace for AI-native project management. " <>
          ...
          " Act on clear requests within their authorized scope. Keep scope and checks proportionate; retain work ownership and honor explicit Stop. Finish requested work and necessary checks before saying done plainly. Owner-waived optional verification must not block completed work; actual implementation, required-check, deployment, or authority blockers remain blocked. Mention only material limitations. Keep final chat replies short and outcome first; keep progress in the run trace, not separate chat messages. Omit repetitive awaiting-feedback, unverified, and no-new-improvement boilerplate. Use scratchpad only for a durable root cause, decision, or dead end; skip routine progress and simple Q&A."
