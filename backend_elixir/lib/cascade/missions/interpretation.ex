defmodule Cascade.Missions.Interpretation do
  ...
  def prompt(wake) do
    ...
    #{if Cascade.Chat.Delegation.enabled?(wake.coordinatorRegistrationId), do: agenda_guidance(), else: Cascade.Chat.Delegation.guidance()}
