    ...
    <main className="desktop-chooser-shell">
      <section className="desktop-chooser-panel" aria-labelledby="desktop-chooser-title">
        ...
        <div className="desktop-chooser-intro">
          ...
          <h2 id="desktop-chooser-title">{onConnectLocal ? 'Choose a server' : 'Choose a vault'}</h2>
          <p>{onConnectLocal ? 'Connect to this server or sign in to another one.' : 'Your local vaults and connected online instances live here.'}</p>
        </div>
        <div className="desktop-chooser-vaults" aria-label="Vaults">
          ...
          {!vaults.length && !onConnectLocal && <p className="desktop-chooser-empty">No vaults yet.</p>}
        ...
        {!onConnectLocal && <button type="button" className="desktop-chooser-continue" onClick={onContinue} disabled={!vaults.length}>Open selected vault</button>}
      </section>
    </main>
  );
}
