...
export default function App() {
  ...
  }, [activeVaultId, user?.id, authEpoch, loadVaultData, loadNoteContent, loadChatAgentMembers, loadChatMessages, loadChatPresence, openChatTabIds, openNote, syncChatPresenceRooms, scheduleCommunityRefresh]);
  ...
  }, [chatState.registeredAgentsByChannel, chatPresenceByChannel, chatDraftsByVault, handleChatDraftChange, currentUsername, user, loadingChatChannels, runnerHealth, vaultAgents, myAgents, handleCancelChatRun, handleInviteChatUser, handleRemoveChatParticipant, handleLeaveChatChannel, handleRegisterChatAgent, handleRemoveChatAgent, handleUpsertVaultAgent, handleDeleteVaultAgent, handleDeleteAgentProfile, handleAddVaultAgentToChannel, handleImportMyAgentToChannel, handleSendChatMessage, handleForwardChatMessage, noteContents, notes, getNoteChangeHandler, getNoteSaveHandler, getNoteRenameHandler, handleExecuteDirective, handleOpenWikilink, openNote, chatMembersOpen, activeVaultId, handleHydrateChatMessage, handleOpenSharedChatNote, superkanbanNotes, superkanbanLiveWork, superkanbanLoading, superkanbanError, chatJumpTarget, handleChatJumpHandled, loadVaultData, renderMissionChat, missionRefreshToken]);
